# -*- coding: utf8 -*-
# we should add test cases here because we can miss some cases while
# writing automation code or some manuel testers (test analystes) can
# handle this more efficiently we can obtain test cases from test
# management tools, I used this for my previous project:
